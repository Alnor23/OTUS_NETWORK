...
```
Далее создается access-list в который входит 5 адресов автономной системы AS2042 (СПб)(в качестве пула была выбрано 5 адресов из сети  VPC8 10.2.3.0/28):  
```
R18(config)#do sh run | s acc
access-list 1 permit 10.2.3.0 0.0.0.7
```
Затем мы настраиваем трансляцию:  
```
R18(config)#do sh run | sec ip nat
ip nat inside source list 1 interface Ethernet0/2 overload
```
...
Pro Inside global      Inside local       Outside local      Outside global
icmp 50.50.1.10:31925  10.2.3.2:31925     50.50.1.9:31925    50.50.1.9:31925
icmp 50.50.1.10:32181  10.2.3.2:32181     50.50.1.9:32181    50.50.1.9:32181
icmp 50.50.1.10:32437  10.2.3.2:32437     50.50.1.9:32437    50.50.1.9:32437
