...
### IPv6  
  ...
  - Сеть для связи офисов с провайдерами 20FF:ODB8:ACAD:7000::/64 предпоследний хекстет будет соответствовать номеру устройства а последний номеру интерфейса  
